...
zIndex="zuzu_logs171019_all_static2_20171030.1628"
curl -XDELETE http://zf-2:9200/$zIndex

/usr/share/logstash/bin/logstash -f /home/ubuntu/elk_log/projets/www_epfl/static2_all_grok.conf --path.data /home/ubuntu/elk_log/projets/www_epfl/logstash_data_$zIndex
