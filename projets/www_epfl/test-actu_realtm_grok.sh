...
zIndex="toto_20180502"
#curl -XDELETE http://zf-2:9200/$zIndex

/usr/share/logstash/bin/logstash -f /home/ubuntu/elk_log/projets/www_epfl/test-actu_realtm_grok.conf --path.data /home/ubuntu/elk_log/projets/www_epfl/logstash_data_$zIndex
